...
//
//	mockgen -source emobility.go -destination mock_emobility_test.go -package emobility
//
...
func (mr *MockEmobilityDataProviderMockRecorder) EVProvidedChargePlan(plan any) *gomock.Call {
...
func (mr *MockEmobilityDataProviderMockRecorder) EVProvidedChargePlanConstraints(constraints any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmobilityDataProviderMockRecorder) EVProvidedChargeStrategy(strategy any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmobilityDataProviderMockRecorder) EVProvidedEnergyDemand(demand any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmobilityDataProviderMockRecorder) EVRequestIncentives(demand, constraints any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmobilityDataProviderMockRecorder) EVRequestPowerLimits(demand, constraints any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmobilityIMockRecorder) EVWriteIncentives(data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmobilityIMockRecorder) EVWriteLoadControlLimits(limits any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmobilityIMockRecorder) EVWritePowerLimits(data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

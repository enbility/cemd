...
// ContractualConsumptionNominalMax provides a mock function with given fields: entity
func (_m *UCLCPInterface) ContractualConsumptionNominalMax(entity api.EntityRemoteInterface) (float64, error) {
...
// UCLCPInterface_ContractualConsumptionNominalMax_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ContractualConsumptionNominalMax'
type UCLCPInterface_ContractualConsumptionNominalMax_Call struct {
	*mock.Call
}

// ContractualConsumptionNominalMax is a helper method to define mock.On call
//   - entity api.EntityRemoteInterface
func (_e *UCLCPInterface_Expecter) ContractualConsumptionNominalMax(entity interface{}) *UCLCPInterface_ContractualConsumptionNominalMax_Call {
	return &UCLCPInterface_ContractualConsumptionNominalMax_Call{Call: _e.mock.On("ContractualConsumptionNominalMax", entity)}
}

func (_c *UCLCPInterface_ContractualConsumptionNominalMax_Call) Run(run func(entity api.EntityRemoteInterface)) *UCLCPInterface_ContractualConsumptionNominalMax_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *UCLCPInterface_ContractualConsumptionNominalMax_Call) Return(_a0 float64, _a1 error) *UCLCPInterface_ContractualConsumptionNominalMax_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UCLCPInterface_ContractualConsumptionNominalMax_Call) RunAndReturn(run func(api.EntityRemoteInterface) (float64, error)) *UCLCPInterface_ContractualConsumptionNominalMax_Call {
	_c.Call.Return(run)
	return _c
}

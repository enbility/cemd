...
import (
	...
	ucevcc "github.com/enbility/cemd/ucevcc"
)
...
func (_m *UCEVCCInterface) ManufacturerData(entity api.EntityRemoteInterface) (*ucevcc.ManufacturerData, error) {
	ret := _m.Called(entity)
	...
	var r0 *ucevcc.ManufacturerData
	var r1 error
	if rf, ok := ret.Get(0).(func(api.EntityRemoteInterface) (*ucevcc.ManufacturerData, error)); ok {
		return rf(entity)
	}
	if rf, ok := ret.Get(0).(func(api.EntityRemoteInterface) *ucevcc.ManufacturerData); ok {
		r0 = rf(entity)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ucevcc.ManufacturerData)
		}
	}
...
func (_c *UCEVCCInterface_ManufacturerData_Call) Return(_a0 *ucevcc.ManufacturerData, _a1 error) *UCEVCCInterface_ManufacturerData_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UCEVCCInterface_ManufacturerData_Call) RunAndReturn(run func(api.EntityRemoteInterface) (*ucevcc.ManufacturerData, error)) *UCEVCCInterface_ManufacturerData_Call {
	_c.Call.Return(run)
	return _c
}
